 ...
 */
export function appendOnce(parent, childElement) {
 ...
 * @param childElement
 */
export function replace(parent, childElement) {
 ...
 */
export function replaceStylesheetLinkElement(
  parent,
  ...
  parent.appendChild(
    createStylesheetLinkElement(stylesheetLinkElementAttributes),
  )
}
 ...
 * @param parent
 * @param styleElementAttributes
 */
export function replaceStyleElement(parent, styleElementAttributes) {
  ...
  parent.appendChild(createStyleElement(styleElementAttributes))
}
 ...
 * @param attributes
 */
export function createStyleElement(attributes) {
 ...
 */
export function createStylesheetLinkElement(attributes) {
