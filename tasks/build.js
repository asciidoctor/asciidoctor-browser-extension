...
Builder.prototype.generateFirefoxManifest = function () {
  const manifestPath = ospath.join(import.meta.dirname, '..', 'app', 'manifest.json')
  ...
  fs.writeFileSync(ospath.join(import.meta.dirname, '..', 'dist', 'manifest-firefox.json'), JSON.stringify(manifest, null, 2))
}
