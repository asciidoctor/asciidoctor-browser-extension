...
* Modernize `fade-navigation.js` and `navigation.js`, add a new `dark-mode-before-render.js` example, and move all three from `contrib` into the Antora documentation as downloadable examples of the JavaScript "before"/"after" load hooks
