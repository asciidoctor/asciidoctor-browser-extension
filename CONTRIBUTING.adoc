...
.. Update the package with [.path]_dist/asciidoctor-browser-extension-opera-<version>.zip_ (the Opera validator rejects the default package over the `.adoc` files it doesn't recognize)
.. Publish the new version
